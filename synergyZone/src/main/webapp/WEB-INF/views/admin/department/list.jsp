...
<div class="container-800" style="margin-left: 5%;">
	<h3>부서 통합관리</h3>
	<br>
		<button class="btn btn-light"><a href="${pageContext.request.contextPath}/admin/department/register">추가</a></button>
		      ...
		      <table class="table table-hover mt-2" style="width: 90%;">
		        ...
		        <tbody>
		            ...
		            <tr>
	                  ...
	                  <td class="align-middle"><a href="${pageContext.request.contextPath}/admin/department/delete?deptNo=${departmentDto.deptNo}">삭제</a></td>
		            </tr>
		          </c:forEach>
		        </tbody>
		      </table>
