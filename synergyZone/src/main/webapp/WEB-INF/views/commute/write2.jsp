...
<form action="/commute/trip" method="post">
    <table class="table table-hover">
        ...
        <tr>
            <th>신청일시</th>
            <td>
                <input type="date" id="startDate" name="startDate" min="YYYY-01-01" max="YYYY-12-31"> ~
                <input type="date" id="endDate" name="endDate" min="YYYY-01-01" max="YYYY-12-31">
        ...
        <tr>
            <th>출발지</th>
            <td>
                <input type="text" name="startPlace" placeholder="출발지를 입력해주세요">
                <button class="add-btn">경유지 추가</button>
            </td>
        </tr>
        ...
        <tr id="hide" style="display: none;">
            <th>경유지</th>
            <td>
                <input type="text" name="middlePlace" placeholder="경유지를 입력해주세요"><button class="del-btn">삭제</button>
            </td>
        </tr>
        <tr>
            <th>목적지</th>
            <td><input type="text" name="endPlace" placeholder="목적지를 입력해주세요"></td>
        </tr>
        <tr>
            <th>장소</th>
