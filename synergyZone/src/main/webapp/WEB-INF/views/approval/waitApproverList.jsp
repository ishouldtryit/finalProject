...
<script>
        Vue.createApp({
            ...
            methods:{
                async loadData(){
                    const resp = await axios.get(contextPath+"/rest/approval/waitApproverList");
                ...
                async move(page) {
                	 ...
                	 this.ApprovalWithPageVO.paginationVO.pageStatus = this.pageStatus; // pageStatus 추가
                	  const resp = await axios.post(contextPath+"/rest/approval/waitApproverMoveList", this.ApprovalWithPageVO.paginationVO);
