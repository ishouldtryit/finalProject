...
<script type="text/template" id="reply-template">
	...
	<div class="row" style="box-shadow: 1px 1px 3px rgba(0, 0, 0, 0.15);">
		<div class="col-md-10 mb-4 offset-md-1 text-start">
			...
			<a href="/board/delete?boardNo=${boardDto.boardNo}" class="btn btn-light"><i class="fa-solid fa-trash-can" style="color: #8f8f8f;"></i>&nbsp;삭제</a>
			</c:if>
...
<div class="border container-fluid">
	...
	<div class="row mt-4">
		<div class="col-md-10 offset-md-1">
			<h3>${boardDto.boardTitle} ${boardDto.jobName}[${boardDto.boardReply}]
						<!-- 하트자리 -->
			...
			<div class="d-flex align-items-center">
			  ...
			  <h6 class="text" style="margin-left: 10px; margin-top:10px; font-weight: nomal"> ${boardDto.empName}
